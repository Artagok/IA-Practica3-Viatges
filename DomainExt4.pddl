(define (domain viatge)
    ...
    (:action visitar_primera_ciutat
        ...
        :effect (and (ciutat_final ?c2) (visitada ?c2) (increase (ciutats_visitades) 1) (increase (dies_totals_visitats) (num ?r)) (increase (preuTotalViatge)(* (num ?r) (preuH ?h))) (increase (preuTotalViatge) (preuV ?v)) (increase (interes_viatge) (interes ?c2)))
    )

    (:action visitar_seguent_ciutat
        :parameters (?v - vol ?c1 - ciutat ?c2 - ciutat ?h - hotel ?r - numDies)
        :precondition (and (uneix ?v ?c1 ?c2) (pertany ?h ?c2) (ciutat_final ?c1) (not (visitada ?c2)))
        :effect (and (not (ciutat_final ?c1)) (ciutat_final ?c2) (visitada ?c2) (increase (ciutats_visitades) 1) (increase (dies_totals_visitats) (num ?r))  (increase (preuTotalViatge)(* (num ?r) (preuH ?h))) (increase (preuTotalViatge) (preuV ?v)) (increase (interes_viatge) (interes ?c2)))
    )

    (:action acabar
        :parameters (?v - vol ?c1 - ciutat ?c2 - ciutat)
        :precondition (and (uneix ?v ?c1 ?c2) (ciutat_final ?c1) (ciutat_inicial ?c2) (<= (ciutats_a_visitar) (ciutats_visitades)) (>= (dies_totals_visitats) (min_dies_viatge)) (<= (preuTotalViatge) (preuMaximViatge)) (>= (preuTotalViatge) (preuMinimViatge)))
